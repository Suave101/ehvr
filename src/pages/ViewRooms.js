        ...
        <>
            ...
            {featuredRooms.length > 0 && (
                <div className="container mb-5" style={{ marginTop: "2rem" }}>
                    ...
                    <div className="row g-4 align-items-end" style={{ display: 'flex' }}>
                        {/* Place the Luxury Experience (idx 0) in the center column, higher than others */}
                        <div className="col-md-4 order-1 order-md-2 d-flex align-items-stretch" style={{ zIndex: 2, marginBottom: '-32px' }}>
                            {featuredRooms[0] && (() => {
                        ...
                        {/* Left: Most Amenities */}
                        <div className="col-md-4 order-2 order-md-1 d-flex align-items-stretch">
                            {featuredRooms[1] && (() => {
                        ...
                        {/* Right: Best Value */}
                        <div className="col-md-4 order-3 d-flex align-items-stretch">
                            {featuredRooms[2] && (() => {
            ...
            <div className="container">
                <div className="bg-secondary bg-opacity-25 rounded-4 p-4 mb-4 shadow-sm">
                    <SearchBar />
                </div>
            </div>
            <style>{`
                ...
                .ehvr-btn-wave:after {
                  ...
                  width: 220%;
                  height: 100%;
                  background: linear-gradient(120deg,rgba(0,188,212,0.12) 0%,rgba(13,110,253,0.10) 100%);
                  transform: skewX(-18deg);
                  transition: left 0.5s cubic-bezier(.4,1.6,.6,1);
                  z-index: 0;
                }
                .ehvr-btn-wave:hover:after {
                  left: 0;
                }
                .ehvr-btn-wave span {
                  position: relative;
            ...
            `}</style>
            <div style={{ padding: "2rem", background: "linear-gradient(120deg, #e0eafc 0%, #cfdef3 100%)", borderRadius: 32, boxShadow: "0 8px 32px rgba(0,0,0,0.08)" }}>
                    ...
                    {rooms.map((room, idx) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                />
                                <div className="p-4 d-flex flex-column justify-content-center" style={{ flex: 1, minWidth: 0 }}>
